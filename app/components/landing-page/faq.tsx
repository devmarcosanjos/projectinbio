export default function Faq() {
  ...
  return (
    <div className="my-20 flex-col items-center gap-16">
      <h1 className="text-4xl font-bold text-white">Dúvidas frequentes</h1>
...
function FAQItem({
  ...
  return (
    <div className="w-[351px] h-min flex flex-col gap-3 p-5 rounded-2xl border-border-primary bg-border-primary">
